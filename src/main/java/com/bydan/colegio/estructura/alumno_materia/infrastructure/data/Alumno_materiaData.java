...
public class Alumno_materiaData implements Alumno_materiaDataI {
	...
	@Autowired
	private Alumno_materiaCrudRepositoryI alumno_materia_crudrepositoryi1;
	...
	public ArrayList<Alumno_materia> getTodos(Pagination pagination1) {  
        try	{			
			...
			this.alumno_materiaModels = this.alumno_materia_crudrepositoryi1.findAll();				
	...
	public Alumno_materia getBuscarUno(Long id) {  
        try	{			
            ...
            this.alumno_materiaModel1 = this.alumno_materia_crudrepositoryi1.findById(id);
    ...
    public Alumno_materia nuevo(Alumno_materia alumno_materia1) {
        try	{			           
			...
			alumno_materiaModel2 = this.alumno_materia_crudrepositoryi1.save(alumno_materiaModel2);
	...
	public void eliminar(Long id) {  
        try	{			          
			this.alumno_materia_crudrepositoryi1.deleteById(id);
	...
	public ArrayList<Alumno_materia> nuevos(ArrayList<Alumno_materia> alumno_materias) {
        try	{		
			...
			this.alumno_materiaModels = this.alumno_materia_crudrepositoryi1.saveAll(alumno_materiaModels2);
	...
	public void eliminars(ArrayList<Long> ids) {  
        try	{			          
			this.alumno_materia_crudrepositoryi1.deleteAllById(ids);
	...
	public void actualizars(ArrayList<Alumno_materia> updates_alumno_materias,ArrayList<String> updates_columnas) {  
        try	{			           
			...
			//this.alumno_materiaModels = this.alumno_materia_crudrepositoryi1.update('id',updates_alumno_materias);
	...
	public Alumno_materiaCrudRepositoryI getAlumno_materiaCrudRepositoryI1() {
		return this.alumno_materia_crudrepositoryi1;	
	}
	
	public void setAlumno_materiaCrudRepositoryI1(Alumno_materiaCrudRepositoryI alumno_materia_crudrepositoryi1) {
		this.alumno_materia_crudrepositoryi1 = alumno_materia_crudrepositoryi1;
	}
}
