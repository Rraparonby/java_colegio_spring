...
/*import com.bydan.colegio.estructura.alumno_materia.infrastructure.data.Alumno_materiaCrudRepositoryI;*/
...
class Alumno_materiaController { //extends GeneralEntityController
	/*
	@Autowired
	...
	*/
	...
	public Alumno_materiaController() {
		...
		/*this.alumno_materiaLogicI.setAlumno_materia_repository1(this.alumno_materia_crudrepositoryi1);*/
	...
	/*
	public void setToDataAlumno_materiaCrudRepositoryI() {
		this.alumno_materiaLogicI.setAlumno_materia_repository1(this.alumno_materia_crudrepositoryi1);	
	}
	*/
