...
public class MateriaData implements MateriaDataI {
	...
	@Autowired
	private MateriaCrudRepositoryI materia_crudrepositoryi1;
	...
	public ArrayList<Materia> getTodos(Pagination pagination1) {  
        try	{			
			...
			this.materiaModels = this.materia_crudrepositoryi1.findAll();				
	...
	public Materia getBuscarUno(Long id) {  
        try	{			
            ...
            this.materiaModel1 = this.materia_crudrepositoryi1.findById(id);
    ...
    public Materia nuevo(Materia materia1) {
        try	{			           
			...
			materiaModel2 = this.materia_crudrepositoryi1.save(materiaModel2);
	...
	public void eliminar(Long id) {  
        try	{			          
			this.materia_crudrepositoryi1.deleteById(id);
	...
	public ArrayList<Materia> nuevos(ArrayList<Materia> materias) {
        try	{		
			...
			this.materiaModels = this.materia_crudrepositoryi1.saveAll(materiaModels2);
	...
	public void eliminars(ArrayList<Long> ids) {  
        try	{			          
			this.materia_crudrepositoryi1.deleteAllById(ids);
	...
	public void actualizars(ArrayList<Materia> updates_materias,ArrayList<String> updates_columnas) {  
        try	{			           
			...
			//this.materiaModels = this.materia_crudrepositoryi1.update('id',updates_materias);
	...
	public MateriaCrudRepositoryI getMateriaCrudRepositoryI1() {
		return this.materia_crudrepositoryi1;	
	}
	
	public void setMateriaCrudRepositoryI1(MateriaCrudRepositoryI materia_crudrepositoryi1) {
		this.materia_crudrepositoryi1 = materia_crudrepositoryi1;
	}
}
