...
public class AlumnoData implements AlumnoDataI {
	...
	@Autowired
	private AlumnoCrudRepositoryI alumno_crudrepositoryi1;
	...
	public ArrayList<Alumno> getTodos(Pagination pagination1) {  
        try	{			
			...
			this.alumnoModels = this.alumno_crudrepositoryi1.findAll();				
	...
	public Alumno getBuscarUno(Long id) {  
        try	{			
            ...
            this.alumnoModel1 = this.alumno_crudrepositoryi1.findById(id);
    ...
    public Alumno nuevo(Alumno alumno1) {
        try	{			           
			...
			alumnoModel2 = this.alumno_crudrepositoryi1.save(alumnoModel2);
	...
	public void eliminar(Long id) {  
        try	{			          
			this.alumno_crudrepositoryi1.deleteById(id);
	...
	public ArrayList<Alumno> nuevos(ArrayList<Alumno> alumnos) {
        try	{		
			...
			this.alumnoModels = this.alumno_crudrepositoryi1.saveAll(alumnoModels2);
	...
	public void eliminars(ArrayList<Long> ids) {  
        try	{			          
			this.alumno_crudrepositoryi1.deleteAllById(ids);
	...
	public void actualizars(ArrayList<Alumno> updates_alumnos,ArrayList<String> updates_columnas) {  
        try	{			           
			...
			//this.alumnoModels = this.alumno_crudrepositoryi1.update('id',updates_alumnos);
	...
	public AlumnoCrudRepositoryI getAlumnoCrudRepositoryI1() {
		return this.alumno_crudrepositoryi1;	
	}
	
	public void setAlumnoCrudRepositoryI1(AlumnoCrudRepositoryI alumno_crudrepositoryi1) {
		this.alumno_crudrepositoryi1 = alumno_crudrepositoryi1;
	}
}
