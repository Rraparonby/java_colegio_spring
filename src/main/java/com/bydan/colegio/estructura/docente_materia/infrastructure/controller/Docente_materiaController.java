...
/*import com.bydan.colegio.estructura.docente_materia.infrastructure.data.Docente_materiaCrudRepositoryI;*/
...
class Docente_materiaController { //extends GeneralEntityController
	/*
	@Autowired
	...
	*/
	...
	public Docente_materiaController() {
		...
		/*this.docente_materiaLogicI.setDocente_materia_repository1(this.docente_materia_crudrepositoryi1);*/
	...
	/*
	public void setToDataDocente_materiaCrudRepositoryI() {
		this.docente_materiaLogicI.setDocente_materia_repository1(this.docente_materia_crudrepositoryi1);	
	}
	*/
