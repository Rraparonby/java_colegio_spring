...
public class Docente_materiaData implements Docente_materiaDataI {
	...
	@Autowired
	private Docente_materiaCrudRepositoryI docente_materia_crudrepositoryi1;
	...
	public ArrayList<Docente_materia> getTodos(Pagination pagination1) {  
        try	{			
			...
			this.docente_materiaModels = this.docente_materia_crudrepositoryi1.findAll();				
	...
	public Docente_materia getBuscarUno(Long id) {  
        try	{			
            ...
            this.docente_materiaModel1 = this.docente_materia_crudrepositoryi1.findById(id);
    ...
    public Docente_materia nuevo(Docente_materia docente_materia1) {
        try	{			           
			...
			docente_materiaModel2 = this.docente_materia_crudrepositoryi1.save(docente_materiaModel2);
	...
	public void eliminar(Long id) {  
        try	{			          
			this.docente_materia_crudrepositoryi1.deleteById(id);
	...
	public ArrayList<Docente_materia> nuevos(ArrayList<Docente_materia> docente_materias) {
        try	{		
			...
			this.docente_materiaModels = this.docente_materia_crudrepositoryi1.saveAll(docente_materiaModels2);
	...
	public void eliminars(ArrayList<Long> ids) {  
        try	{			          
			this.docente_materia_crudrepositoryi1.deleteAllById(ids);
	...
	public void actualizars(ArrayList<Docente_materia> updates_docente_materias,ArrayList<String> updates_columnas) {  
        try	{			           
			...
			//this.docente_materiaModels = this.docente_materia_crudrepositoryi1.update('id',updates_docente_materias);
	...
	public Docente_materiaCrudRepositoryI getDocente_materiaCrudRepositoryI1() {
		return this.docente_materia_crudrepositoryi1;	
	}
	
	public void setDocente_materiaCrudRepositoryI1(Docente_materiaCrudRepositoryI docente_materia_crudrepositoryi1) {
		this.docente_materia_crudrepositoryi1 = docente_materia_crudrepositoryi1;
	}
}
