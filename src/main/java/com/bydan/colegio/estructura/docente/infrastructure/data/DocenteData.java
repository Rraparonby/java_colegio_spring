...
public class DocenteData implements DocenteDataI {
	...
	@Autowired
	private DocenteCrudRepositoryI docente_crudrepositoryi1;
	...
	public ArrayList<Docente> getTodos(Pagination pagination1) {  
        try	{			
			...
			this.docenteModels = this.docente_crudrepositoryi1.findAll();				
	...
	public Docente getBuscarUno(Long id) {  
        try	{			
            ...
            this.docenteModel1 = this.docente_crudrepositoryi1.findById(id);
    ...
    public Docente nuevo(Docente docente1) {
        try	{			           
			...
			docenteModel2 = this.docente_crudrepositoryi1.save(docenteModel2);
	...
	public void eliminar(Long id) {  
        try	{			          
			this.docente_crudrepositoryi1.deleteById(id);
	...
	public ArrayList<Docente> nuevos(ArrayList<Docente> docentes) {
        try	{		
			...
			this.docenteModels = this.docente_crudrepositoryi1.saveAll(docenteModels2);
	...
	public void eliminars(ArrayList<Long> ids) {  
        try	{			          
			this.docente_crudrepositoryi1.deleteAllById(ids);
	...
	public void actualizars(ArrayList<Docente> updates_docentes,ArrayList<String> updates_columnas) {  
        try	{			           
			...
			//this.docenteModels = this.docente_crudrepositoryi1.update('id',updates_docentes);
	...
	public DocenteCrudRepositoryI getDocenteCrudRepositoryI1() {
		return this.docente_crudrepositoryi1;	
	}
	
	public void setDocenteCrudRepositoryI1(DocenteCrudRepositoryI docente_crudrepositoryi1) {
		this.docente_crudrepositoryi1 = docente_crudrepositoryi1;
	}
}
