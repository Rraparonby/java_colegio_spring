...
public class ContratoData implements ContratoDataI {
	...
	@Autowired
	private ContratoCrudRepositoryI contrato_crudrepositoryi1;
	...
	public ArrayList<Contrato> getTodos(Pagination pagination1) {  
        try	{			
			...
			this.contratoModels = this.contrato_crudrepositoryi1.findAll();				
	...
	public Contrato getBuscarUno(Long id) {  
        try	{			
            ...
            this.contratoModel1 = this.contrato_crudrepositoryi1.findById(id);
    ...
    public Contrato nuevo(Contrato contrato1) {
        try	{			           
			...
			contratoModel2 = this.contrato_crudrepositoryi1.save(contratoModel2);
	...
	public void eliminar(Long id) {  
        try	{			          
			this.contrato_crudrepositoryi1.deleteById(id);
	...
	public ArrayList<Contrato> nuevos(ArrayList<Contrato> contratos) {
        try	{		
			...
			this.contratoModels = this.contrato_crudrepositoryi1.saveAll(contratoModels2);
	...
	public void eliminars(ArrayList<Long> ids) {  
        try	{			          
			this.contrato_crudrepositoryi1.deleteAllById(ids);
	...
	public void actualizars(ArrayList<Contrato> updates_contratos,ArrayList<String> updates_columnas) {  
        try	{			           
			...
			//this.contratoModels = this.contrato_crudrepositoryi1.update('id',updates_contratos);
	...
	public ContratoCrudRepositoryI getContratoCrudRepositoryI1() {
		return this.contrato_crudrepositoryi1;	
	}
	
	public void setContratoCrudRepositoryI1(ContratoCrudRepositoryI contrato_crudrepositoryi1) {
		this.contrato_crudrepositoryi1 = contrato_crudrepositoryi1;
	}
}
