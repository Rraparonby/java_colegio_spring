...
public class SueldoData implements SueldoDataI {
	...
	@Autowired
	private SueldoCrudRepositoryI sueldo_crudrepositoryi1;
	...
	public ArrayList<Sueldo> getTodos(Pagination pagination1) {  
        try	{			
			...
			this.sueldoModels = this.sueldo_crudrepositoryi1.findAll();				
	...
	public Sueldo getBuscarUno(Long id) {  
        try	{			
            ...
            this.sueldoModel1 = this.sueldo_crudrepositoryi1.findById(id);
    ...
    public Sueldo nuevo(Sueldo sueldo1) {
        try	{			           
			...
			sueldoModel2 = this.sueldo_crudrepositoryi1.save(sueldoModel2);
	...
	public void eliminar(Long id) {  
        try	{			          
			this.sueldo_crudrepositoryi1.deleteById(id);
	...
	public ArrayList<Sueldo> nuevos(ArrayList<Sueldo> sueldos) {
        try	{		
			...
			this.sueldoModels = this.sueldo_crudrepositoryi1.saveAll(sueldoModels2);
	...
	public void eliminars(ArrayList<Long> ids) {  
        try	{			          
			this.sueldo_crudrepositoryi1.deleteAllById(ids);
	...
	public void actualizars(ArrayList<Sueldo> updates_sueldos,ArrayList<String> updates_columnas) {  
        try	{			           
			...
			//this.sueldoModels = this.sueldo_crudrepositoryi1.update('id',updates_sueldos);
	...
	public SueldoCrudRepositoryI getSueldoCrudRepositoryI1() {
		return this.sueldo_crudrepositoryi1;	
	}
	
	public void setSueldoCrudRepositoryI1(SueldoCrudRepositoryI sueldo_crudrepositoryi1) {
		this.sueldo_crudrepositoryi1 = sueldo_crudrepositoryi1;
	}
}
