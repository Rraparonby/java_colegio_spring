...
public class NotaData implements NotaDataI {
	...
	@Autowired
	private NotaCrudRepositoryI nota_crudrepositoryi1;
	...
	public ArrayList<Nota> getTodos(Pagination pagination1) {  
        try	{			
			...
			this.notaModels = this.nota_crudrepositoryi1.findAll();				
	...
	public Nota getBuscarUno(Long id) {  
        try	{			
            ...
            this.notaModel1 = this.nota_crudrepositoryi1.findById(id);
    ...
    public Nota nuevo(Nota nota1) {
        try	{			           
			...
			notaModel2 = this.nota_crudrepositoryi1.save(notaModel2);
	...
	public void eliminar(Long id) {  
        try	{			          
			this.nota_crudrepositoryi1.deleteById(id);
	...
	public ArrayList<Nota> nuevos(ArrayList<Nota> notas) {
        try	{		
			...
			this.notaModels = this.nota_crudrepositoryi1.saveAll(notaModels2);
	...
	public void eliminars(ArrayList<Long> ids) {  
        try	{			          
			this.nota_crudrepositoryi1.deleteAllById(ids);
	...
	public void actualizars(ArrayList<Nota> updates_notas,ArrayList<String> updates_columnas) {  
        try	{			           
			...
			//this.notaModels = this.nota_crudrepositoryi1.update('id',updates_notas);
	...
	public NotaCrudRepositoryI getNotaCrudRepositoryI1() {
		return this.nota_crudrepositoryi1;	
	}
	
	public void setNotaCrudRepositoryI1(NotaCrudRepositoryI nota_crudrepositoryi1) {
		this.nota_crudrepositoryi1 = nota_crudrepositoryi1;
	}
}
