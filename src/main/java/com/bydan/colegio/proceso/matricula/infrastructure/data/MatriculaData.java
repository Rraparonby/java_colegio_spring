...
public class MatriculaData implements MatriculaDataI {
	...
	@Autowired
	private MatriculaCrudRepositoryI matricula_crudrepositoryi1;
	...
	public ArrayList<Matricula> getTodos(Pagination pagination1) {  
        try	{			
			...
			this.matriculaModels = this.matricula_crudrepositoryi1.findAll();				
	...
	public Matricula getBuscarUno(Long id) {  
        try	{			
            ...
            this.matriculaModel1 = this.matricula_crudrepositoryi1.findById(id);
    ...
    public Matricula nuevo(Matricula matricula1) {
        try	{			           
			...
			matriculaModel2 = this.matricula_crudrepositoryi1.save(matriculaModel2);
	...
	public void eliminar(Long id) {  
        try	{			          
			this.matricula_crudrepositoryi1.deleteById(id);
	...
	public ArrayList<Matricula> nuevos(ArrayList<Matricula> matriculas) {
        try	{		
			...
			this.matriculaModels = this.matricula_crudrepositoryi1.saveAll(matriculaModels2);
	...
	public void eliminars(ArrayList<Long> ids) {  
        try	{			          
			this.matricula_crudrepositoryi1.deleteAllById(ids);
	...
	public void actualizars(ArrayList<Matricula> updates_matriculas,ArrayList<String> updates_columnas) {  
        try	{			           
			...
			//this.matriculaModels = this.matricula_crudrepositoryi1.update('id',updates_matriculas);
	...
	public MatriculaCrudRepositoryI getMatriculaCrudRepositoryI1() {
		return this.matricula_crudrepositoryi1;	
	}
	
	public void setMatriculaCrudRepositoryI1(MatriculaCrudRepositoryI matricula_crudrepositoryi1) {
		this.matricula_crudrepositoryi1 = matricula_crudrepositoryi1;
	}
}
